                        ...
                        <div class="form-group mt-4 row">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                                <select class="form-select" id="p1" name="p1" required>
                                    ...
                                    <option value="3">Con tendencia al desacuerdo</option>
                                    <option value="4">Con tendencia al acuerdo</option>
                                    <option value="5">De acuerdo</option>
                                    <option value="6">En fuerte acuerdo</option>
                                </select>
                            </div>
                        </div>
