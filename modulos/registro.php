...
<script>
    function alert_aviso() {
        var text = "¡Muchas gracias por haber aceptado participar en este estudio!<br>Tu tarea consistirá en jugar un juego. La duración de la sesión dependerá del tiempo en el que realices esta tarea, sin embargo, el tiempo de duración promedio no excede los 20 minutos.<br>El objetivo de este estudio es obtener información sobre habilidades blandas. No buscamos evaluar inteligencia o memoria.<br>En caso de ser necesario, los datos que proporciones serán confidenciales y se utilizarán para fines investigativos exclusivamente.<br>Finalmente, al aceptar participar en este estudio, te comprometes a no divulgar información sobre los procedimientos realizados porque ello podría afectar el desempeño de otros estudiantes o personas que decidan participar con nosotros.";
