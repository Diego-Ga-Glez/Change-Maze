            ...
            <div class="card-deck mb-3 mt-5">
                ...
                <div class="card mb-4 box-shadow">
                    ...
                    <div class="card-header">
                        <h4 class="text-center">Encuesta ERC</h4>
                        <h6 class="text-center">Oreg shaul 2003</h6>
                    </div>
                    
                    <div class="card-body p-5">

                        <p align="justify">A continuación se presenta una serie de opiniones vinculadas al trabajo y a nuestra actividad en la
                            misma. Le agradeceremos nos responda con absoluta sinceridad, marcando la respuesta
                            que mejor exprese su punto de vista.</p>
                        <p><b>FD</b> = En fuerte desacuerdo<br>
                            <b>ED</b> = En desacuerdo<br>
                            <b>TD</b> = Con tendencia al desacuerdo<br>
                            <b>TA</b> = Con tendencia al acuerdo<br>
                            <b>DA</b> = De acuerdo<br>
                            <b>FA</b> = En fuerte acuerdo</p>
                        <p align="justify">No hay respuesta buena ni mala, todas son importantes. Asegúrese de haber contestado todas las
                            preguntas.</p>
